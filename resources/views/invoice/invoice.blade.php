                                ...
                                <table class="table  " id="table" width="100%" style="font-size: 12px;">
                                    ...
                                    foreach ($invoice as $inv) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?= number_format($inv->voucher, 0) ?>
                                            </td>
                                            <td>
                                                <?= number_format($inv->dp, 0) ?>
                                            </td>
                                            <td>
                                                <?= number_format($inv->gosen, 0) ?>
                                            </td>
                                            <td>
                                                <?= number_format($inv->total_bayar, 0) ?>
                                            </td>
                                            <td>
                                                <?= number_format($inv->cash, 0) ?>
                                            </td>
                                            <td>
                                                <?= number_format($inv->d_bca, 0) ?>
                                            </td>
                                            <td>
                                                <?= number_format($inv->k_bca, 0) ?>
                                            </td>
                                            <td>
                                                <?= number_format($inv->d_mandiri, 0) ?>
                                            </td>
                                            <td>
                                                <?= number_format($inv->k_mandiri, 0) ?>
                                            </td>
                                            <td>
                                                <?= $inv->admin ?>
                                            </td>
